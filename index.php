...
<body>
	...
	<header>
		<div class="logo">
			...
			<span class="policies">Privacy e termini</span>
		</div>
		<nav>
			<ul>
			...
			<span class="my-account">tonystank@gmail.com</span>
		</nav>
	...
	<main>
		<div class="container">
			...
			<ul>
				<?php foreach ($faq as $titolo => $corpo):?>
				<li>
					<h2><?php echo $titolo.'<br>';?></h2>
					<?php foreach ($corpo as $value) : ?>
